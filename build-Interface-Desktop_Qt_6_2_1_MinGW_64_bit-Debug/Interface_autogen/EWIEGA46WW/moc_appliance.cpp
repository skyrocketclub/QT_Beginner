...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Appliance_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Appliance_t qt_meta_stringdata_Appliance = {
    {
QT_MOC_LITERAL(0, 9) // "Appliance"
...
const QMetaObject Appliance::staticMetaObject = { {
    ...
    qt_meta_stringdata_Appliance.offsetsAndSize,
    qt_meta_data_Appliance,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Appliance_t
, QtPrivate::TypeAndForceComplete<Appliance, std::true_type>
...
void *Appliance::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Appliance.stringdata0))
